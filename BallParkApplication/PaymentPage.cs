...
namespace BallParkApplication
{
    public partial class PaymentPage : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            var command = String.Format("Insert INTO [Transaction] ([Transaction_Status], [Customer_Id], [Transaction_Date]) VALUES ('{0}', {1}, '{2}')", "Success", Utility.Utility.Customer.Cid, DateTime.Now.ToString("MM/dd/yyyy"));
